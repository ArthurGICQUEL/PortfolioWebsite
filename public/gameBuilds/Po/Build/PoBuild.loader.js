      ...
      function n() {
        function r(r) {
          if ('undefined' == typeof n.database)
            for (
              n.database = r, n.database || e('indexedDB database could not be opened');
              n.queue.length;
        ...
        if (this.database)
          try {
            var a = this.database
              .transaction(
                [e],
                ['put', 'delete', 'clear'].indexOf(r) != -1 ? 'readwrite' : 'readonly'
              )
              .objectStore(e)
                      ...
                      (s.onload = function () {
                        ;(o.revalidated = ['Last-Modified', 'ETag'].every(function (e) {
                          return (
                            ...
                            o.result.responseHeaders[e] == s.getResponseHeader(e)
                          )
                        })),
                          o.revalidated
